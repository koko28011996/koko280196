<?php
    ...
    function update_sp($id,$tenhh,$giahh,$giamgia,$filename,$ngaynhap,$mota,$dacbiet,$slxem,$iddm){
    if($filename!="")
        $sql = "UPDATE `hanghoa` SET `ten_hh`='$tenhh',`don_gia`='$giahh',`giam_gia`='$giamgia',`hinh`='$filename',`ngay_nhap`='$ngaynhap',`mo_ta`='$mota',`dac_biet`='$dacbiet',`so_luot_xem`='$slxem',`iddm`='$iddm' WHERE id=".$id;
    else
